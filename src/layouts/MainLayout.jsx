  ...
  return (
    <div className="min-vh-100 d-flex flex-column">
      <nav className="navbar navbar-expand-lg sticky-top py-3 shadow-sm">
        <div className="container">
          ...
          >
            ...
            <span className="d-none d-sm-inline">EXPENSE & BUDGET APP</span>
            <span className="d-inline d-sm-none fw-bold">E&B APP</span>
          </NavLink>
      ...
      <footer className="text-center py-4 text-muted small border-top mt-auto">
        <div className="container">
          <p className="mb-0">
            © 2026 <strong>EXPENSE & BUDGET APP</strong> - by KM to manage your
